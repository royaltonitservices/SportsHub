...
// MARK: - User Search Row Preview (dev-only production-surface render proof, Gate 1.4E)

#Preview("Search row — Add + Report/Block") {
    UserSearchRowView(
        user: UserResponse(
            id: "u2", email: "r@x.com", username: "rival_player", displayName: "Rival Player",
            fullName: "Rival Player", isAdmin: false, createdAt: "2026-09-09T12:00:00Z",
            emailVerified: true, surveyCompleted: true, isLegacyAccount: false),
        currentUserId: "me",
        onAddFriend: {},
        onBlocked: {}
    )
