...
struct WeeklyDrillsView: View {
    ...
    // MARK: - Error View (server unavailable)
    ...
    private func errorView(_ message: String) -> some View {
        VStack(spacing: Spacing.lg) {
            ...
            VStack(spacing: Spacing.sm) {
                Text("Personalized Drills Unavailable")
                    .font(.headline)
                    .foregroundStyle(Color.appTextPrimary)

                Text("Weekly drills are generated by the server. While it's unreachable, you can browse the full drill library below.")
                    .font(.subheadline)
                    .foregroundStyle(Color.appTextSecondary)
                    .multilineTextAlignment(.center)
